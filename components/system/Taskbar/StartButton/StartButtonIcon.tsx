...
// import startButtonImage from '../../../../public/System/Icons/144x144/b-pondering.png'; // adjust the path accordingly

const StartButtonIcon = memo(() => (
  <img
    alt="Start Button"
    src="https://sdk.bitmoji.com/me/sticker/JXKekKDxnVOUJx2CjnopniATyVeig0bGqzyNqTVZDdcWEW4HEwIsmQ/10227146.png?p=dD1zO2w9ZW4.v1&size=thumbnail"
    width={50}
  />
));
