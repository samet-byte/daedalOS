...
import { type ProxyState } from "components/apps/SimpleBrowser/useProxyMenu";
import {
  createDirectoryIndex,
  type DirectoryEntries,
} from "components/apps/SimpleBrowser/directoryIndex";
import StyledBrowser from "components/apps/SimpleBrowser/StyledBrowser";
import {
  DINO_GAME,
  HOME_PAGE,
  LOCAL_HOST,
  ...
  type WaybackUrlInfo,
  bookmarks,
} from "components/apps/SimpleBrowser/config";
